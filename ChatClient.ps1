...
"@
            ...
            "configure_network_security_ntlm_minimum_session_security_client" {
            ...
            "configure_network_security_ntlm_minimum_session_security_server" {
                $regPath = "HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0"
                New-Item -Path $regPath -Force -ErrorAction SilentlyContinue | Out-Null
            ...
            "configure_service_remote_desktop_services_usermode_port_redirector" {
